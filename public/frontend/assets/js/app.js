...
// ============================================
// ANIMATED CODE BACKGROUND & ANIMATIONS
// ============================================

// Add animated code background to hero sections
function addAnimatedCodeBackground() {
    const heroSections = document.querySelectorAll('.Barmagly-hero-section, .Barmagly-hero-section7, .Barmagly-hero-section8');
...
function addFloatingCodeElements() {
    const sections = document.querySelectorAll('.section, .Barmagly-hero-section');
    
    sections.forEach((section, index) => {
        if (index % 2 === 0 && !section.querySelector('.floating-code')) {
            const codeElements = [
                '<div class="container">',
                'function init() {',
                'const api = fetch();',
...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.project-card-item, .Barmagly-service-item, .Barmagly-iconbox-wrap').forEach(el => {
        observer.observe(el);
    });
}
...
function addTypingAnimation() {
    const headings = document.querySelectorAll('.Barmagly-hero-content h1, .Barmagly-section-title h2');
    
    headings.forEach((heading, index) => {
        if (index === 0) { // Only first heading
...
function addButtonAnimations() {
    const buttons = document.querySelectorAll('.Barmagly-default-btn, .project-view-btn');
...
function addIconGlow() {
    const icons = document.querySelectorAll('.Barmagly-iconbox-icon, .Barmagly-service-icon');
...
document.addEventListener("DOMContentLoaded", () => {
    addAnimatedCodeBackground();
    addFloatingCodeElements();
